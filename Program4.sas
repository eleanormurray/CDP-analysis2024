...
run;
		...
		proc logistic data = onesample (where = (adhbin0 ne . and adhr_t1 ne . and  visit >0 and adh_measure_flag = 1)) descending noprint;
		...
		proc logistic data=onesample (where =(adhbin0 ne . and adhr_t1 ne . and visit >0 and adhr_t_flag = 1)) descending noprint;
...
run;
	...
	%else %do;
		...
		proc logistic data = bootsample (where =(adhbin0 ne . and adhr_t1 ne . and  visit >0 and adh_measure_flag = 1)) descending noprint;
		...
		proc logistic data=bootsample (where =(adhbin0 ne . and adhr_t1 ne . and  visit >0 and adhr_t_flag = 1 )) descending noprint;
